...
public class Particle extends GameObject {
    ...
    public static void explodePlayer(Vector2D position, Vector2D velocity, int width, int height, Color color, int timeIntervalCreate, int timeIntervalChangeSize) {
        if (frameCounter == null) {
            frameCounter = new FrameCounter(timeIntervalCreate);
        }
        if (frameCounter.run()) {
